...
<div class="card shadow mb-4">
    ...
    <div class="card-body" style="padding-left: 400px; padding-right: 400px; padding-bottom: 10px; padding-text-outline: 10px;">
        ...
        <form class="row g-3" method="post" action="/user/add">
            <div class="col-md-6">
            ...
            <div class="col-4">
                ...
                <input type="password" class="form-control" id="inputPassword" placeholder="Password" name="password" value="${user.pass}">
            </div>
            <div class="col-4">
                <br/>
                <label for="inputRepeatPassword" class="form-label">&nbsp;</label>
                <input type="password" class="form-control" id="inputRepeatPassword" placeholder="Repeat password" name="repeatPassword">
            </div>
            <div class="col-12">
                <br/>
